...
export const DH = () => {
 ...
 <nav>
    <h1 >  💊Chikitsa</h1>
         <Link to='/DH'>🏠Home</Link>
    <a href="#" onClick={scrollToAboutUs}>📝About</a>
    <a href="#" onClick={ServicesSection}>⚙️Services</a>
    <a href="#" onClick={ContactSection}>📞Contact</a>
              <Link to = '/DocPage '>👨🏽‍⚕️NOTIFICATIONS</Link>
              {/* <Link to = '/DocAppt' >🗓️Appointments </Link> */}
           {/* <Link to = '/DocCon' >🩺Previous consultancies</Link> */}
          <Link to ='/DocProfile'>👤Profile</Link>
  </nav>
